                    ...
                    <form action="{{ route('listas.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-1">
                            <div class="col-lg-8 col-md-6 form-floating mb-3 p-0">
                                <input type="text" class="form-control h-100" id="inputName" placeholder="Nome da Lista" name="name" required>
                            ...
                            <div class="col-lg-8 col-md-6 form-floating mb-3 p-0">
                                <input type="url" class="form-control" id="inputUrl" placeholder="Link da imagem de capa (Opcional)" name="url_background">
