                    ...
                    <form action="{{ route('cards.update', $card) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-1">
                            <div class="col-lg-12 col-sm-6 form-floating mb-3">
                                <input type="text" class="form-control h-100" id="inputTopic" placeholder="Nome do tópico" name="topic" value="{{ $card->topic }}" required>
                                <label for="inputTopic">Digite o tópico</label>
                            </div>
                            <div class="col-lg-12 col-sm-6 form-floating mb-3">
                                <textarea class="form-control" placeholder="Digite a questão" id="inputQuestion" name="question" required>{{ $card->question }}</textarea>
                                <label for="inputQuestion">Digite a questão</label>
                            </div>
                            <div class="col-lg-12 col-sm-6 form-floating mb-3">
                                <textarea class="form-control" placeholder="Digite a resposta da questão" id="inputQuestionAnswer" name="question_answer">{{ $card->question_answer }}</textarea>
